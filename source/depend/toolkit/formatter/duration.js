import { deep_clone } from "../../core.js";
 ...
 */
export function format_duration(value, unit, expression, mode = default_mode_config) {
    let {
        "convert": convert_mode, "carry": carry_mode
    } = mode, date_info = {};

    let origin_unit = nickname_mapping[unit.origin],
        target_unit = nickname_mapping[unit.target];
